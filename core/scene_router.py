...
AVAILABLE_SCENES = {
    ...
    "scene_meta_bot_interaction": "Операция 'Легализовать взаимодействие с ИИ'. Человек спрашивает о природе бота ('ты не живой', 'ты следишь за контекстом'). Нужен вопрос о ценности процесса вне зависимости от собеседника.",
...
if __name__ == "__main__":
    test_phrases = [
        ...
        "Ты ведь не живой",  # meta_bot_interaction
    ]
