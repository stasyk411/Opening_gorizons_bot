...
AVAILABLE_SCENES = {
    ...
    "scene_mental_filter": "Операция 'Восстановить полную картину'. Человек фиксируется на одном негативном факте, игнорируя фон ('одна ошибка всё испортила'). Нужен вопрос о контексте.",
    "scene_fortune_telling": "Операция 'Вернуть неопределённость будущего'. Человек считает прогноз фактом ('точно знаю, что провалюсь'). Нужен вопрос о фактах vs предположениях.",
    "scene_comparison": "Операция 'Вернуть фокус на личную динамику'. Человек измеряет себя чужим эталоном ('у всех лучше', 'на его фоне я ничто'). Нужен вопрос о собственном критерии.",
...
if __name__ == "__main__":
    test_phrases = [
        ...
        "Всё было хорошо, но эта одна ошибка всё испортила",  # mental_filter
        "Я точно знаю, что всё закончится плохо",  # fortune_telling
        "У всех получается лучше, чем у меня",  # comparison
    ]
